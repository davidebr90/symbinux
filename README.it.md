...
**GNU AGPLv3** (GNU Affero General Public License v3, o successiva). Scelta
al posto della GPL semplice per coprire anche l'uso in rete/SaaS del codice,
non solo la distribuzione. Vedi [LICENSE](LICENSE).
